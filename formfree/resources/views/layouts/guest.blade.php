...
<style>
  ...
  @keyframes ff-bar-grow{0%{width:0%}25%{width:55%}60%{width:78%}100%{width:88%}}
  @keyframes ff-bar-shine{0%{background-position:100% 0}100%{background-position:-100% 0}}
  #ff-bar.done{width:100%!important;animation:none!important;transition:width .12s ease,opacity .25s ease .1s;opacity:0}
  #ff-overlay{
  ...
  .ff-pressed{opacity:.65!important;transform:scale(.97)!important;pointer-events:none!important;position:relative;}
  .ff-pressed::after{
